...
if myConnection:
cursor=myConnection.cursor()
createTable ="""CREATE TABLE IF NOT EXISTS CUSTOMER(CID VARCHAR(10) PRIMARY KEY
,CNAME VARCHAR(30) NOT NULL,ADDRESS VARCHAR(30)NOT NULL ,PHONE VARCHAR(12) NOT NULL)
"""
...
print("\nERROR ESTABLISHING MYSQL CONNECTION !")# MODULE TO SEARCH A CUSTOMER
def searchCustomer():
global cid
if myConnection:
cursor=myConnection.cursor()
...
data=cursor.execute(sql,values)
data = cursor.fetchall()
if data:createTable ="""CREATE TABLE IF NOT EXISTS ACCOUNT(CID VARCHAR(10),ACCOUNT_NO INT
PRIMARY KEY
...
data = cursor.fetchall()
if data:
print("\n*****DETAILS OF ALL CUSTOMER*****")print(data)
else:
...
print("Sorry ! Account Infromation NOT Found , Please Try Again ! ")#MODULE TO PROVIDE HELP FOR USER
def helpMe():
...
print("*****ADVITIYA SHARMA - CLASS XII A - ROLL NO - 1 [２０１９-２０２０]")
print("*****AKSHIT WALIA - CLASS XII A - ROLL NO - 3 [２０１９-２０２０]")
print("*****KARTIK CHAUHAN - CLASS XII A - ROLL NO - 9 [２０１９-２０２０]")
print("*****SHUBHAM DOGRA - CLASS XII A - ROLL NO - 22 [２０１９-２０２０]")
...
!")
print("! PLEASE ENTER 2 TO DISPLAY ALL CUSTOMERS print("! PLEASE ENTER 3 TO SEARCH A CUSTOMER !")
